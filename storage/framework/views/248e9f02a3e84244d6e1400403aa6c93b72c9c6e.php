       ...
       <!-- <div class="ibox-title">
        ...
        <div class="ibox-content">
            ...
            <form  class="m-t" role="form" action="/conteudo/<?php echo e($conteudo->id); ?>" method="POST">
                    ...
                    <div id="divRespostaAlternativa" style="display:none">                        
                        ...
                        <div class="form-group row">
                            <div id="divFlutuanteRespostas">  
                                    <?php $__currentLoopData = $respostas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $RespostaItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                        ...
                                        <div id="divResposta<?php echo e($loop->iteration); ?>">
                                            ...
                                            <div class='col-sm-1' style='padding-top: 5px;'>
                                                <?php if($RespostaItem->RespostaCorreta =='1'): ?>
                ...
                <input type="text" name="QuantidadeRespostas" id="QuantidadeRespostas" value="<?php echo e(count($respostas)); ?>" hidden>
                </div>
